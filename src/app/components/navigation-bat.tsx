...
export function NavigationBar() {
  return (
    <nav className="bg-white flex flex-row justify-between lg:justify-start lg:w-3xs lg:flex-col py-4 px-6 lg:gap-y-6 lg:py-10 lg:px-6 lg:h-dvh z-10 border-b lg:border-r border-gray-300">
